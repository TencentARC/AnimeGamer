...
def add_model_config_args(parser):
    ...
    group.add_argument("--base", type=str, nargs="*", default=["./VDM_Decoder/configs/cogvideox_2b.yaml","./VDM_Decoder/configs/inference.yaml"], help="config for input and saving")
    group.add_argument(
    ...
    group.add_argument("--loss_save_path", type=str, default=None)
    return parser
...
def add_sampling_config_args(parser):
    ...
    group.add_argument("--test-path", type=str, default="samples")
    group.add_argument("--LLM_output_path", type=str, default="samples")
    group.add_argument("--extra-motion", type=str, default=None)
    group.add_argument("--sampling-image-size", type=list, default=[ 480, 720 ])
    group.add_argument("--input-dir", type=str, default=None)
    group.add_argument("--prompt-type", type=str, default='human')
