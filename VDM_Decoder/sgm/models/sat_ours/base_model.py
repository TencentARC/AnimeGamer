...
from .transformer import BaseTransformer, standard_attention
from sat.arguments import update_args_with_file, overwrite_args_by_dict, set_random_seed
from sat.training.model_io import load_checkpoint
from sat.helpers import print_rank0

from .transformer_defaults import HOOKS_DEFAULT, ARGS_DEFAULT
        ...
        if transformer is not None:
            ...
            self.transformer = BaseTransformer(
                ...
                **args_dict,
                ...
                use_attached_ip_cross_attn=args.use_attached_ip_cross_attn,
                **kwargs
            )
